...
function About() {
  return (
    <ScrollView maxWidth={500} maxHeight="80vh" alignItems="center">
      ...
      <AboutText>
        No data is collected by the gpt-anime servers. This means none of the information sent to
        OpenAI or Google is stored by gpt-anime. The same goes for any data received from these
        APIs.
      </AboutText>
      ...
      <AboutText>
        ...
        <AboutAnchor href="https://github.com/ruslanmv/gpt-anime" target="_blank">
      ...
      <AboutText>
        ...
        <AboutAnchor href="mailto:contact@ruslannv.com">contact@ruslanmv.com</AboutAnchor>
      </AboutText>
    </ScrollView>
  );
}
